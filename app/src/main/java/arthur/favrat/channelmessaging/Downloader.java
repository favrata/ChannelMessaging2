...
public class Downloader extends AsyncTask<Void, Void, String> {
    ...
    public Downloader(Context context, String url, HashMap<String, String> request) {
        this.context = context;
        this.url = url;
        this.request = request;
    }

    public void setOnDownloadCompleteListner(OnDownloadCompleteListener onDownloadCompleteListener) {
        listeners.add(onDownloadCompleteListener);
    }

    @Override
    protected String doInBackground(Void... params) {
        return performPostCall(url, request);
    }
